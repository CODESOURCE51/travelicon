<?php include_once('templates/header.php');?>
    ...
    <div id="main-content">
        ...
        <div class="page-title">
            <div>
                <h1><i class="fa fa-file-o"></i> Faculty Update</h1>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <div class="box-title">
                        <h3><i class="fa fa-bars"></i>Faculty Update</h3>
                    ...
                    <div class="box-content">
                        <form name="service_form" action="<?php echo base_url();?>admin.php/Update/Faculty" method="post" enctype="multipart/form-data" class="form-horizontal" onsubmit="return validate_faculty();">
                          <input type="hidden" name="cid" value="<?php echo $data[0]['f_id'];?>" />
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           ...
                                           data-original-title="Mandatory ***" data-placement="top" name="txt_service" id="txt_service" value="<?php echo $data[0]['name'];?>"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group" id="cont" style="display:block;">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <textarea class="form-control show-popover" rows="3" data-trigger="hover"
                                           ...
                                           data-original-title="Optional" data-placement="top" name="txt_notes" id="txt_notes"><?php echo $data[0]['desig'];?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                <img src="<?php echo base_url().'faculty/'.$data[0]['img'];?>" height="90" width="110" />
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 col-lg-2 control-label">Previous Resume</label>

                                <div class="col-sm-9 col-lg-10 controls">
                                <a href="<?php echo base_url().'faculty/'.$data[0]['uplds'];?>" target="_blank"><img src="<?php echo base_url();?>uploads/notice.png" height="90" width="110" /></a>
