<?php include_once('templates/header.php');?>
    ...
    <div id="main-content">
        ...
        <div class="page-title">
            <div>
                <h1><i class="fa fa-file-o"></i> Upload Gallery / Slider Image</h1>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <div class="box-title">
                        <h3><i class="fa fa-bars"></i>Upload Gallery / Slider Image</h3>
                    ...
                    <div class="box-content">
                        <form name="service_form" action="<?php echo base_url();?>admin.php/Add/GallerySlider" method="post" enctype="multipart/form-data" class="form-horizontal" onsubmit="return gallery();">
                          <div class="form-group">
                                <label class="col-sm-3 col-lg-2 control-label">Type</label>

                                <div class="col-sm-9 col-lg-10 controls">
                               Gallery : <input type="radio" name="txt_btype" class="txt_btype" value="1" > <br/>
                               Slider : <input type="radio" name="txt_btype" class="txt_btype" value="2" > <br/>
